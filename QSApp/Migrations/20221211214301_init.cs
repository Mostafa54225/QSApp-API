    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClinicAvaliableDays", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClinicAvaliableDays_Clinics_ClinicId",
                        column: x => x.ClinicId,
                        principalTable: "Clinics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClinicAvaliableDays_WeekDays_WeekDayId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClinicAvaliableDays_ClinicId",
                table: "ClinicAvaliableDays",
                column: "ClinicId");

            migrationBuilder.CreateIndex(
                name: "IX_ClinicAvaliableDays_WeekDayId",
                table: "ClinicAvaliableDays",
                column: "WeekDayId");
